...
|---|---:|---:|---:|---:|---:|
| tests/fixtures/ex1.inp | ASYMMETRIC (CAMBERED) BODY SOLUTION, EXAMPLE PROBLEM 1, CASE 2 | 0.6 | 45.0% | 21.429% | 19.0% |
| tests/fixtures/ex1.inp | HYPERSONIC BODY SOLUTION,  EXAMPLE PROBLEM 1, CASE 4 | 2.5 | 5.0% | 1.667% | 2.75% |
| tests/fixtures/ex1.inp | APPROXIMATE AXISYMMETRIC BODY SOLUTION, EXAMPLE PROBLEM 1, CASE 1 | 0.6 | 0.0% | 4.762% | 1.0% |
